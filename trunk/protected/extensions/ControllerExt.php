...
class ControllerExt implements Extension {
    ...
    public function before($obj = null) {
        ...
        if ($clientType == 'tablet' || $clientType == 'mobile' || $clientType == 'wechat') {
        ...
        $site_name = isset($site['site_name']) ? $site['site_name'] : '商城';
        $site_icp = isset($site['site_icp']) ? $site['site_icp'] : 'icp备';
