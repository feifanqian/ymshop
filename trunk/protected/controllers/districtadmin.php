...
class DistrictadminController extends Controller
{
    ...
    public function shop_check_register() {
        ...
        $biz_content_arr = array(
            ...
            'bank_province'=>$shop_check['province']!=null?$shop_check['province']:$province['name'],
        ...
        if($res['ysepay_merchant_register_accept_response']['code']==10000) {
           ...
           echo json_encode(array("status" => 'success', 'msg' => '成功'));
            ...
            var_dump($res['ysepay_merchant_register_accept_response']['sub_msg']);die;
    ...
    public function operation_center()
    {
        ...
        $customer = $model->table('customer as c')->fields('c.real_name,c.mobile,u.nickname,u.avatar')->join('left join user as u on c.user_id=u.id')->where('c.user_id='.$user_id)->find();
        $shop = $model->table('district_shop')->fields('create_time')->where('owner_id='.$user_id)->find();
