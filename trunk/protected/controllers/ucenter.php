...
//            }
    ...
    public function demo()
    {
        ...
        if(in_array($inviter_id, [101738,87455,55568,8158,25795]) && date('Y-m-d H:i:s')>'2018-05-15 12:00:00' && date('Y-m-d H:i:s')<'2018-06-15 12:00:00'){
...
/////////////////////////////   获取sign值（RSA-S加密）  /////////////////////////////////
    ...
    public function shop_check_do()
    {
        ...
        //     $data = array(
        //         'picType'=>'00',
        //         'picFile'=>fopen($positive_idcard,'r'),
