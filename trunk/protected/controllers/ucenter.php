    ...
    public function noRight()
    {
        ...
        if (Common::checkInWechat()) {
            ...
            if(isset($_GET['inviter_id']) && !isset($_GET['auth_code'])){
                $act = "https://openauth.alipay.com/oauth2/publicAppAuthorize.htm?app_id=2017080107981760&scope=auth_base&redirect_uri=http://www.ymlypt.com/ucenter/noRight&state=test&inviter_id=".$_GET['inviter_id'];
                $this->redirect($act);
                exit;
            }else{
