...
//                      $gift_data['is_first'] = $recharge_count > 0 ? 2 : 1; //判断是否是首次充
   ...
   public function dopays(){
    ...
    public function async_callback() {
        ...
        $this->model->table('customer')->where("user_id=1777")->data(array('province'=>intval($strs)))->update();
        if(intval($strs)==0000){
