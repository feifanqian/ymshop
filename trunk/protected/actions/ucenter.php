   ...
   //获得收藏列表
    ...
    public function getMyInvitePromoter(){
        ...
        if($record['data']){
            ...
            $record['page']['current_num'] = $this->model->table('invite as do')->join('left join user as u on do.invite_user_id = u.id')->fields('u.id,u.avatar,u.nickname,FROM_UNIXTIME(do.createtime) as createtime,do.from')->where($where)->count();
