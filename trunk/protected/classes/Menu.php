...
class Menu {
    ...
    public function __construct() {
        $nodes = array(
            ...
            '/customer/balance_list' => array('name' => '金点日志', 'parent' => 'balance'),
            '/customer/silver_list' => array('name' => '银点日志', 'parent' => 'balance'),
            ...
            '/marketing/recharge_activity_list' => array('name' => '充值活动', 'parent' => 'promotions'),
            '/marketing/recharge_activity_list' => array('name' => '充值活动', 'parent' => 'promotions'),
            '/marketing/recharge_package_set' => array('name' => '充值套餐', 'parent' => 'promotions'),
            '/marketing/recharge_activity_edit' => array('name' => '编辑充值活动', 'parent' => 'promotions'),
