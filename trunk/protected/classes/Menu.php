...
class Menu {
    ...
    public function __construct() {
        $nodes = array(
            ...
            '/content/index_ad' => array('name' => '首页广告', 'parent' => 'banner'),
            ...
            '/content/center_add' => array('name' => '商圈添加', 'parent' => 'center','hidden'=>true),
            '/content/center_edit' => array('name' => '商圈编辑', 'parent' => 'center','hidden'=>true),
            ...
            '/goods/goods_edits' => array('name' => '分类编辑', 'parent' => 'goods','hidden'=>true),
            ...
            '/customer/blacklist' => array('name' => '黑名单', 'parent' => 'customer'),
            '/customer/blacklist_add' => array('name' => '添加黑名单', 'parent' => 'customer', 'hidden'=>true),
            '/customer/blacklist_edit' => array('name' => '修改黑名单', 'parent' => 'customer', 'hidden'=>true),
        ...
        $subMenu = array(
            ...
            'center' => array('name' => '商圈管理', 'parent' => 'content'),
