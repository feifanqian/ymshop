...
{
	// 签名证书路径
	static $SDK_SIGN_CERT_PATH = 'certs/acp_prod_sign.pfx';
	// 签名证书密码
	static $SDK_SIGN_CERT_PWD = '000000';
	// 密码加密证书（这条一般用不到的请随便配）
	static $SDK_ENCRYPT_CERT_PATH = 'certs/acp_prod_verify_sign.cer';
	// 验签证书路径（请配到文件夹，不要配到具体文件）
	static $SDK_VERIFY_CERT_DIR = 'certs/';
	...
	static function sign(&$params)
	{
        ...
        static function setCertPath($mode)
        {    if($mode == 'app'){
               self::$SDK_SIGN_CERT_PATH = "appcerts/acp_prod_sign.pfx";
               self::$SDK_ENCRYPT_CERT_PATH = "appcerts/acp_prod_verify_sign.cer";
               self::$SDK_VERIFY_CERT_DIR = "appcerts/";
              }
              if($mode == 'wap'){
               self::$SDK_SIGN_CERT_PATH = "wapcerts/acp_prod_sign.pfx";
               self::$SDK_ENCRYPT_CERT_PATH = "wapcerts/acp_prod_verify_sign.cer";
               self::$SDK_VERIFY_CERT_DIR = "wapcerts/";
              }
              if($mode =='pc'){
               self::$SDK_SIGN_CERT_PATH = "certs/acp_prod_sign.pfx";
               self::$SDK_ENCRYPT_CERT_PATH = "certs/acp_prod_verify_sign.cer";
               self::$SDK_VERIFY_CERT_DIR = "certs/";
              }
        }
	 ...
	 * @return unknown
	 */
	static function encryptData($data, $cert_path='')
	{       if($cert_path==''){
	 ...
	 * @return unknown
	 */
	static function decryptData($data, $cert_path="")
	{       if($cert_path==''){
                     $cert_path=self::$SDK_SIGN_CERT_PATH;
                }
