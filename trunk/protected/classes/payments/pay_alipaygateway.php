<?php
 /**
 * @class pay_alipaygateway
 * @brief 支付宝[网关支付]插件类
 */
class pay_alipaygateway extends PaymentPlugin{

    //支付插件名称
    public $name = '支付宝';

    private $banks = array('ICBC'=>'ICBC-DEBIT','CCB'=>'CCB','ABC'=>'ABC','PSBC'=>'POSTGC','COMM'=>'COMM','CMB'=>'CMB','BOC'=>'BOC-DEBIT','CEB'=>'CEB-DEBIT','CITIC'=>'CITIC','SPDB'=>'SPDB','CMBC'=>'CMBC','CIB'=>'CIB','SPABANK'=>'SPABANK','GDB'=>'GDB','SHRCB'=>'SHRCB','SHBANK'=>'SHBANK','NBBANK'=>'NBBANK','HZCB'=>'HZCBB2C','BJBANK'=>'BJBANK','BJRCB'=>'BJRCB','FDB'=>'FDB','WZCB'=>'WZCBB2C-DEBIT','ZJNX'=>'ZJNX','CDCB'=>'CDCB','CSRCB'=>'CSRCB','NJCB'=>'NJCB');
    //提交地址
