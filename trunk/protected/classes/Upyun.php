...
class Upyun {
    ...
    public function __construct() {
        ...
        // $this->_username = '793219239@qq.com';
        $this->_username = 'operator1';
        // $this->_password = md5($upyun['upyun_password']);
        // $this->_password = md5('cong13480794861');
        $this->_password = md5('ym123456');
        $this->_timeout = 30;
    ...
    public function request($method, $path, $headers = NULL, $body = NULL, $file_handle = NULL) {
        return $this->_do_request($method, $path, $headers, $body, $file_handle);
    }
