...
class WechatApi extends Wechat {
    ...
    protected function onSubscribe() {
        ...
        $items = array();
        $items[] = new NewsResponseItem("欢迎光临圆梦共享网", "", "http://img.buy-d.cn/data/uploads/2016/09/07/b4f135e20157b7928bf8c892500f8f3c.png", "http://www.ymlypt.com/");
        ...
        if ($eventkey) {
            ...
            if(is_numeric($eventkey)){
                ...
                if(empty($result)){
                     ...
                     $news = array();
                     if($is_first){
                        $news[] = new NewsResponseItem("欢迎光临圆梦共享网", "", "http://img.buy-d.cn/data/uploads/2016/09/07/b4f135e20157b7928bf8c892500f8f3c.png", "http://www.ymlypt.com/"); 
